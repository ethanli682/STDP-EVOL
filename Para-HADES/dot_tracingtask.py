...
def episodeFileName(base, ep):
    """Per-episode sibling of a genFileName() path.

    `<dir>/rew_s1234_train.csv` -> `<dir>/rew_s1234_train_ep00007.csv`.
    Zero-padded so a plain `ls`/glob sorts in episode order.
    """
