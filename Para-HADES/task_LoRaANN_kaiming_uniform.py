...
def run_task(param, args):
    ...
    def generate_scaffold():
        ...
        w1 = torch.empty(input_size, hidden_size, device=device)
        nn.init.kaiming_uniform_(w1)
        w2 = torch.empty(hidden_size, output_size, device=device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gpu", type=str, default='True')          # pass to the next process
